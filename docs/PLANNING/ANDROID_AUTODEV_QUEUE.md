...
| S16-NUI-P0-004 | S16-NUI | P0 | BLOCKED_LIVE_HTML_MISMATCH | Search fixture capture | Save search response to fixtures/real-source/xingxingxsw/search/ | Fixture files exist | Parser updated, live site returns empty (blocking/anti-bot) |
| S16-NUI-P0-005 | S16-NUI | P0 | BLOCKED_LIVE_HTML_MISMATCH | Detail smoke + fixture capture | Get BookInfo from search result detailUrl | Fixture replay works | Parser updated, blocked on live site access |
| S16-NUI-P0-006 | S16-NUI | P0 | BLOCKED_LIVE_HTML_MISMATCH | TOC smoke + fixture capture | Get TOC from BookInfo.tocUrl | Fixture replay works | Blocked on S16-NUI-P0-005 |
| S16-NUI-P0-007 | S16-NUI | P0 | BLOCKED_LIVE_HTML_MISMATCH | Content smoke + fixture capture | Get ContentPage from TOC chapter URL | Fixture replay works | Blocked on S16-NUI-P0-006 |
