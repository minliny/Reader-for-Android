...
| P2-S5-006 | S5 | P2 | READY | Wire real HTTP fetch + Core parse for search | Modify SearchViewModel to use real HTTP + parse | Real search returns results from a book source | None | No |
