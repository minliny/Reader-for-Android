window.IMMERSIVE_READING_FIXTURE = {
  info: {
    topLeft: "长夜余火 · 第 32 章",
    time: "10:30",
    progress: "38%",
  ...
  zones: [
    { type: "previous", label: "上一页热区" },
    { type: "menu", label: "点击中心呼出控制层" },
    { type: "next", label: "下一页热区" }
  ],
  feedback: {
    loading: {
      title: "正在加载",
      copy: "正在加载当前章节，保留阅读背景和弱信息层。"
    },
    error: {
      title: "加载失败，请重试",
      copy: "章节内容读取失败，返回来源页后仍保留阅读位置。",
      primaryAction: "重试"
    },
    offline: {
      title: "网络不可用，请稍后重试",
      copy: "已显示本地缓存章节，联网后再刷新后续内容。",
      primaryAction: "继续阅读缓存"
    }
  },
  rules: {
    chapterOnlyNote: "当前章节信息只显示当前章节，不显示总章节数"
  }
};
