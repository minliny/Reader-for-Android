...
| P0 条件 | 结论 | 约束来源 |
| --- | --- | --- |
| DARK mode token | 已补齐基础草案 | `freezes/_preflight/UI_FREEZE_READER_CONTROL_LAYER_V1_PREP/06_DESIGN_TOKENS_DRAFT.md` |
...
- `docs/ui-design/drafts/_rejected/`
- `docs/ui-design/drafts/_contact_sheets/`
- `docs/ui-design/drafts/_progress_restore_backup/`
