...
`docs/ui-design/STITCH_UPLOAD_DOC_REQUIREMENTS.md`.
...
`docs/ui-design/freezes/_preflight/UI_FREEZE_READER_CONTROL_LAYER_V1_PREP/06_DESIGN_TOKENS_DRAFT.md` is `TOKEN_SPEC` with authority level `SUPPORTING_SPEC`.
...
The token draft at `docs/ui-design/freezes/_preflight/UI_FREEZE_READER_CONTROL_LAYER_V1_PREP/06_DESIGN_TOKENS_DRAFT.md` remains non-final. Missing final fields are the
