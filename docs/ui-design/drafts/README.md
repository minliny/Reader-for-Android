...
逐图实现文字稿统一收录在
[`../IMAGE_TEXT_SPEC_CATALOG.md`](../IMAGE_TEXT_SPEC_CATALOG.md)。该总册覆盖正式稿、
...
- 当前侧置悬浮阅读控制层以 `../specs/READER_CONTROL_TABLET_SPEC.md` 的专项规则和
  `../specs/READER_CONTROL_GEOMETRY_SPEC.md` 的统一参数为准。
...
- 阅读控制层详细规则以 `../specs/READER_CONTROL_LAYER_SPEC.md`、
  `../specs/READER_CONTROL_ACTION_FLOWS.md`、
  `../specs/READER_CONTROL_RESPONSIVE_RULES.md`、
  `../specs/READER_CONTROL_GEOMETRY_SPEC.md` 和
  `../specs/READER_CONTROL_IMAGE_USAGE.md` 为准。
