(function attachReaderAssetIcons(window) {
  ...
  const icons = {
    ...
    "chevron-left": '<svg class="asset-icon" viewBox="0 0 48 48"><path d="m30 10-13 14 13 14"></path></svg>',
    ...
    code: '<svg class="asset-icon" viewBox="0 0 48 48"><path d="m18 16-9 8 9 8"></path><path d="m30 16 9 8-9 8"></path><path d="m27 10-6 28"></path></svg>',
    ...
    "current-location": '<svg class="asset-icon" viewBox="0 0 48 48"><circle cx="24" cy="24" r="6"></circle><path d="M24 5v8M24 35v8M5 24h8M35 24h8"></path><circle cx="24" cy="24" r="17"></circle></svg>',
    ...
    help: '<svg class="asset-icon" viewBox="0 0 48 48"><circle cx="24" cy="24" r="17"></circle><path d="M18 18a6 6 0 0 1 12 1c0 5-6 5-6 10"></path><path d="M24 36h.01"></path></svg>',
    ...
    "night-mode": '<svg class="asset-icon" viewBox="0 0 48 48"><path d="M34 31c-12 0-19-7-19-19 0-2 .3-4 .9-6A18 18 0 1 0 42 32c-2 .6-5 1-8 1Z"></path></svg>',
    ...
    permission: '<svg class="asset-icon" viewBox="0 0 48 48"><rect x="12" y="21" width="24" height="18" rx="3"></rect><path d="M17 21v-5a7 7 0 0 1 14 0v5"></path><path d="M24 28v5"></path></svg>',
    ...
    stop: '<svg class="asset-icon" viewBox="0 0 48 48"><rect x="14" y="14" width="20" height="20" rx="3" fill="currentColor" stroke="none"></rect></svg>',
