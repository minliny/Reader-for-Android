...
private val motionIdSerialNames: Map<MotionId, String> = mapOf(
    ...
    MotionId.SourceSwitchRoutePush to "source.switch.route.push",
    MotionId.SourceSwitchRoutePop to "source.switch.route.pop",
    MotionId.SourceSwitchRouteReplace to "source.switch.route.replace",
